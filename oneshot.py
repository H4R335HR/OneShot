...
class Companion:
    ...
    def single_connection(self, bssid=None, pin=None, ssid=None, pixiemode=False, pbc_mode=False, showpixiecmd=False,
        ...
        if not pin:
            ...
            elif not pbc_mode and not args.bruteforce:
...
class WiFiScanner:
    ...
    def prompt_network(self) -> tuple:
        ...
        if not networks:
            ...
            return
        while 1:
            if args.auto and self.auto_num is not None:
                if networks[int(self.auto_num)]['ESSID'] is None:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-P', '--pin-index',
        type=int,
        help='Select from index of automatically generated pins'
        )
    parser.add_argument(
        '-B', '--bruteforce',
        action='store_true',
            ...
            if args.pbc:
                ...
                if args.bssid:
                    ...
                    if args.bruteforce:
                        ...
                        companion.single_connection(bssid=args.bssid, pin=args.pin, ssid=args.ssid, 
